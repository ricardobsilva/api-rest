...
RSpec.describe Api::V1::AddressesController, type: :controller do
  ...
  # Api::V1::Address. As you add validations to Api::V1::Address, be sure to
  ...
  # Api::V1::AddressesController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all api_v1_addresses as @api_v1_addresses" do
      address = Api::V1::Address.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:api_v1_addresses)).to eq([address])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested api_v1 as @api_v1" do
      ...
      expect(assigns(:api_v1)).to eq(address)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new api_v1 as @api_v1" do
      ...
      expect(assigns(:api_v1)).to be_a_new(Api::V1::Address)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created api_v1 as @api_v1" do
        post :create, {:api_v1 => valid_attributes}, valid_session
        expect(assigns(:api_v1)).to be_a(Api::V1::Address)
        expect(assigns(:api_v1)).to be_persisted
      end

      it "redirects to the created api_v1" do
        post :create, {:api_v1 => valid_attributes}, valid_session
        expect(response).to redirect_to(Api::V1::Address.last)
      end
    end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested api_v1" do
        address = Api::V1::Address.create! valid_attributes
        put :update, {:id => address.to_param, :api_v1 => new_attributes}, valid_session
        address.reload
      ...
      it "assigns the requested api_v1 as @api_v1" do
        address = Api::V1::Address.create! valid_attributes
        put :update, {:id => address.to_param, :api_v1 => valid_attributes}, valid_session
        expect(assigns(:api_v1)).to eq(address)
      end
    ...
    context "with invalid params" do
      it "assigns the api_v1 as @api_v1" do
        address = Api::V1::Address.create! valid_attributes
        put :update, {:id => address.to_param, :api_v1 => invalid_attributes}, valid_session
        expect(assigns(:api_v1)).to eq(address)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the api_v1_addresses list" do
      address = Api::V1::Address.create! valid_attributes
      delete :destroy, {:id => address.to_param}, valid_session
